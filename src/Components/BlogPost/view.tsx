        ...
        <Posts>
          <Post data-aos='fade-up' data-aos-duration='1000'>
            <PostBox>
              ...
              <Text>
                Illum voluptas ab enim placeat. Adipisci enim velit nulla. Vel omnis laudantium.
                Asperiores eum ipsa est officiis. Modi qui magni est...
              </Text>
          ...
          <Post data-aos='fade-up' data-aos-duration='1000'>
            <PostBox>
              ...
              <Text>
                Voluptatem nesciunt omnis libero autem tempora enim ut ipsam id. Odit quia ab eum
                assumenda. Quisquam omnis doloribus...
              </Text>
              <Link to='/blog-details'>
                <span>
                  Read More  
          ...
          <Post data-aos='fade-up' data-aos-duration='1000'>
            <PostBox>
              ...
              <Text>
                Quia nam eaque omnis explicabo similique eum quaerat similique laboriosam. Quis
                omnis repellat sed quae consectetur magnam...
              </Text>
              <Link to='/blog-details'>
                <span>
                  Read More  
          ...
          <Post data-aos='fade-up' data-aos-duration='1000'>
            <PostBox>
              ...
              <Text>
                Et consequatur eveniet nam voluptas commodi cumque ea est ex. Aut quis omnis sint
                ipsum earum quia eligendi...
              </Text>
              <Link to='/blog-details'>
                <span>
                  Read More  
